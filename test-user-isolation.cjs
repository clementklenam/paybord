...
async function testUserIsolation() {
  try {
    console.log('Testing user isolation in subscription analytics...');
    ...
    const isolationResponse = await axios.get(`${API_BASE}/analytics/test-data-isolation`, {
      headers: {
        'Content-Type': 'application/json',
        // Add your auth token if needed
        // 'Authorization': 'Bearer YOUR_TOKEN'
    ...
    console.log('Data Isolation Test Response:');
    console.log(JSON.stringify(isolationResponse.data, null, 2));
