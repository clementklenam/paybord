  ...
  return (
    ...
    >
      ...
      <circle cx="380" cy="300" r="40" fill="#1e8449" />
      <circle cx="380" cy="300" r="35" fill="#196f3d" />
      <text x="380" y="305" fontFamily="Arial" fontSize="14" fill="white" fontWeight="bold" textAnchor="middle">PayAfric</text>
