    ...
    >
      <defs>
        ...
        <radialGradient id="center-glow" cx="50%" cy="50%" r="50%" fx="50%" fy="50%">
          <stop offset="0%" stopColor="#1e8449" stopOpacity="0.2" />
      ...
      {/* Central PayAfric Hub */}
      <g filter="url(#glow)">
        <circle cx="400" cy="300" r="70" fill="url(#line-gradient)" fillOpacity="0.15" />
        <circle cx="400" cy="300" r="55" fill="url(#hub-gradient)" />
      </g>
      
      <text x="400" y="290" fontFamily="Arial" fontSize="20" fill="white" fontWeight="bold" textAnchor="middle">PayAfric</text>
      ...
      <g filter="url(#glow)">
        {/* North America */}
        <circle cx="150" cy="200" r="35" fill="#f1c40f" />
      ...
      {/* Connection Lines from Global to PayAfric with glowing gradient effect */}
      ...
      <g className="payment-methods" filter="url(#glow)">
        {/* Mobile Money */}
        <circle cx="300" cy="400" r="40" fill="#1e8449" fillOpacity="0.9" stroke="#f1c40f" strokeWidth="2" />
        ...
        {/* Card Payments */}
        <circle cx="500" cy="400" r="40" fill="#1e8449" fillOpacity="0.9" stroke="#f1c40f" strokeWidth="2" />
        <text x="500" y="405" fontFamily="Arial" fontSize="14" fill="white" fontWeight="bold" textAnchor="middle">Cards</text>
        
        {/* Bank Transfers */}
        <circle cx="250" cy="300" r="40" fill="#1e8449" fillOpacity="0.9" stroke="#f1c40f" strokeWidth="2" />
        ...
        {/* Crypto */}
        <circle cx="550" cy="300" r="40" fill="#1e8449" fillOpacity="0.9" stroke="#f1c40f" strokeWidth="2" />
        <text x="550" y="305" fontFamily="Arial" fontSize="14" fill="white" fontWeight="bold" textAnchor="middle">Crypto</text>
        
        {/* USSD */}
        <circle cx="400" cy="450" r="40" fill="#1e8449" fillOpacity="0.9" stroke="#f1c40f" strokeWidth="2" />
        <text x="400" y="455" fontFamily="Arial" fontSize="14" fill="white" fontWeight="bold" textAnchor="middle">USSD</text>
      </g>
      
      {/* Connection Lines from PayAfric to African Payment Methods */}
      ...
      <g className="country-labels">
        <g transform="translate(210, 360)">
          <rect x="-35" y="-15" width="70" height="30" rx="15" fill="white" stroke="#1e8449" strokeWidth="1.5" filter="drop-shadow(0px 2px 4px rgba(0,0,0,0.1))" />
          <text x="0" y="5" fontFamily="Arial" fontSize="11" fill="#1e8449" fontWeight="bold" textAnchor="middle">Nigeria</text>
        ...
        <g transform="translate(350, 380)">
          <rect x="-35" y="-15" width="70" height="30" rx="15" fill="white" stroke="#1e8449" strokeWidth="1.5" filter="drop-shadow(0px 2px 4px rgba(0,0,0,0.1))" />
          <text x="0" y="5" fontFamily="Arial" fontSize="11" fill="#1e8449" fontWeight="bold" textAnchor="middle">Kenya</text>
          <animateTransform attributeName="transform" type="translate" additive="sum" 
            values="0,-5; 0,5; 0,-5" dur="6s" begin="1s" repeatCount="indefinite" />
        </g>
        
        <g transform="translate(580, 350)">
          <rect x="-45" y="-15" width="90" height="30" rx="15" fill="white" stroke="#1e8449" strokeWidth="1.5" filter="drop-shadow(0px 2px 4px rgba(0,0,0,0.1))" />
          <text x="0" y="5" fontFamily="Arial" fontSize="11" fill="#1e8449" fontWeight="bold" textAnchor="middle">South Africa</text>
          <animateTransform attributeName="transform" type="translate" additive="sum" 
        ...
        <g transform="translate(300, 240)">
          <rect x="-35" y="-15" width="70" height="30" rx="15" fill="white" stroke="#1e8449" strokeWidth="1.5" filter="drop-shadow(0px 2px 4px rgba(0,0,0,0.1))" />
          <text x="0" y="5" fontFamily="Arial" fontSize="11" fill="#1e8449" fontWeight="bold" textAnchor="middle">Ghana</text>
          <animateTransform attributeName="transform" type="translate" additive="sum" 
            values="0,-5; 0,5; 0,-5" dur="6s" begin="3s" repeatCount="indefinite" />
        </g>
        
        <g transform="translate(500, 240)">
          <rect x="-40" y="-15" width="80" height="30" rx="15" fill="white" stroke="#1e8449" strokeWidth="1.5" filter="drop-shadow(0px 2px 4px rgba(0,0,0,0.1))" />
          <text x="0" y="5" fontFamily="Arial" fontSize="11" fill="#1e8449" fontWeight="bold" textAnchor="middle">Tanzania</text>
          <animateTransform attributeName="transform" type="translate" additive="sum" 
