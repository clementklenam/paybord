  ...
  return (
    ...
    >
      ...
      <g transform="translate(40, 85)">
        ...
        <rect x="5" y="5" width="30" height="5" rx="2" fill="#6C2BFB" fillOpacity="0.5" />
        <rect x="5" y="15" width="20" height="5" rx="2" fill="#6C2BFB" fillOpacity="0.3" />
      </g>
      ...
      <g transform="translate(70, 130)">
        <rect width="60" height="20" rx="10" fill="#6C2BFB" />
      ...
      {/* Connection lines */}
      <path d="M65 70L115 55" stroke="#6C2BFB" strokeWidth="1" strokeDasharray="3 2" />
      <path d="M115 55L130 95" stroke="#6C2BFB" strokeWidth="1" strokeDasharray="3 2" />
    </svg>
  );
}
